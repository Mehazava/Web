...
namespace DiskLib
{
    public class InfoManager
    {
        ...
        public void Add(InfoItem item, ItemInfoHandler createHandler, ItemInfoHandler modifyHandler, ItemInfoHandler destroyHandler)
        {
        ...
        private string CheckItem(InfoItem item)
        {
            switch (item.Type)
            {
                case ItemType.author:
